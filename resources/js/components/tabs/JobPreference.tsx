        ...
        <div className="space-y-4">
            ...
            <div>
                ...
                <Input
                    id="course"
                    name="course"
                    defaultValue={form.highestEducation?.course || ''}
            ...
            <div>
                ...
                <Input
                    id="school"
                    name="school"
                    defaultValue={form.highestEducation?.school || ''}
                    className={errors.school && 'border border-red-500'}
                />
            ...
            <div className="mb-10">
                ...
                <Input
                    id="year_graduated"
                    name="year_graduated"
                    defaultValue={form.highestEducation?.year_graduated || ''}
                    type="number"
                    className={errors.year_graduated && 'border border-red-500'}
                />
